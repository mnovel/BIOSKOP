...
if (empty($_SESSION['login']['status']) || $_SESSION['login']['role'] != 2) {
...
<head>
    ...
    <link rel="stylesheet" href="<?= BASE_URL ?>template/assets/modules/prism/prism.css">
    ...
    <div id="app">
        <div class="main-wrapper container">
            ...
            <nav class="navbar navbar-expand-lg main-navbar">
                <a href="<?= BASE_URL ?>user/dashboard" class="navbar-brand sidebar-gone-hide">GA.Tix</a>
            ...
            <nav class="navbar navbar-secondary navbar-expand-lg">
                <div class="container">
                    <ul class="navbar-nav">
                        <li class="nav-item <?= preg_match('/dashboard/i', MENU_TITLE) ? 'active' : '' ?>">
                            <a href="<?= BASE_URL ?>user/dashboard" class="nav-link">
                                <i class="fas fa-home"></i>
                                <span>Dashboard</span>
                            </a>
                        </li>
                        <li class="nav-item <?= preg_match('/tiket/i', MENU_TITLE) ? 'active' : '' ?>">
                            <a href="<?= BASE_URL ?>user/tiket" class="nav-link">
